				...
				<div class="card">
					...
					<div class="card-body">             
						<ul class="list-unstyled list-unstyled-border">
							...
							<li class="media">
								<div class="media-body">
									<div class="media-title">{{ $kegiatan->name_kegiatan }}</div>
									<span class="text-small text-muted"> {{ tanggal_indonesia($kegiatan->tanggal_kegiatan,false) }}</span>
								</div>
							</li>
							@empty
						...
						<div class="text-center pt-1 pb-1">
							<a href="{{ route('kegiatans.index') }}" class="btn btn-primary btn-lg btn-round">
								View All
							</a>
						</div>
					</div>
